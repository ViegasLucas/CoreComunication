...
- **35 arquivos** de knowledge bases
...
### Liderança e RH (Smart Leading)

14. **[Framework de Competências e Levels](concepts/framework-de-levels.md)** - Estrutura de progressão
    - Trilhas L1-L4 e Liderança
    - As 8 Competências Nucleares
    - Diretrizes de parametrização da IA

15. **[Guia de Comunicação, 1:1 e Feedback (Modelo SBI)](concepts/guia-de-comunicacao-sbi.md)** - Metodologia de feedback
    - Estrutura da 1:1 (5 blocos)
    - Modelo SBI humanizado
    - Linguagem que abre vs fecha diálogo

16. **[Estrutura Básica do PDI](concepts/estrutura-pdi.md)** - Planos de desenvolvimento
    - Os 4 pilares do PDI
    - Sugestão de ações concretas e prazos
    - Suporte necessário do gestor

17. **[Classificação de Maturidade da Liderança](concepts/classificacao-maturidade-lideranca.md)** - Analytics RH
    - Níveis (Iniciante, Em Desenvolvimento, Consistente, Referência)
    - Critérios de avaliação pela IA

18. **[Estratégia do MVP: Resolução de Questões Críticas (Smart Leading)](product/smart-leading-mvp-strategy.md)** - Definições de Produto ✨ NOVO
    - Privacidade e Acesso do RH
    - Fluxo de Dados e Copiloto de IA
    - Testes e Priorização Estratégica
...
- [Framework de Competências e Levels](concepts/framework-de-levels.md)
- [Guia de Comunicação, 1:1 e Feedback](concepts/guia-de-comunicacao-sbi.md)
- [Estrutura Básica do PDI](concepts/estrutura-pdi.md)
- [Classificação de Maturidade da Liderança](concepts/classificacao-maturidade-lideranca.md)
- [Estratégia do MVP (Smart Leading)](product/smart-leading-mvp-strategy.md)
